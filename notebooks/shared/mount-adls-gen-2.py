...
mountSource = (
    "abfss://"
    + dbutils.widgets.get("storageContainerName")
    + "@"
...
dbutils.notebook.exit(
    '{"mountSource": "' + mountSource + '", "mountPoint": "' + mountPoint + '"}'
)
